...
Zakładam, że dostałeś zadanie w stylu "zrób hat'a, który odbiera GPS", "który steruje silnikiem BLDC" albo "zrób hata z układem scalonym DRV17182". Jeśli się zgadza, to
możesz czytać dalej.
...
Procesor ma swoje piny (to, co podpinasz Arduino do modułów). One zmieniają swoje napięcia i sterują rzeczami wyprowadzonymi na złącze ChainBus. Złącze ma konkretne rzeczy na konkretnych pinach, żeby było
...
\begin{itemize}
  ...
  \item Nie możesz rucszać Interboard connector, Bus switch, ID eeprom na schematic'u. One muszą zostać takie, jakie są
